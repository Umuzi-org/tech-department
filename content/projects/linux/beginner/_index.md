...
You might ask what is sudo? Sudo allows you to run programs with the security previledges of another user, it is also referred to as a superuser. It is often used to install, start and stop applications that require root priviledges.

dpkg is a tool to intall, build remove and manage Debian Packages,
